...
<!-- Vendored from https://github.com/blader/humanizer (SKILL.md, v2.8.0, MIT). Project-local
authoring tool for this repo's public prose; not shipped in the develop plugin payload. -->
